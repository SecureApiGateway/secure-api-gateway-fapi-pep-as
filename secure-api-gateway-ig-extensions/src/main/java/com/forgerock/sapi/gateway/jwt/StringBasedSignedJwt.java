 ...
 */
public class StringBasedSignedJwt extends SignedJwt {

    /**
     * Construct a {code StringBasedSignedJwt} from an existent one.
     * @param signedJwt the signed JWT
     */
    protected StringBasedSignedJwt(final StringBasedSignedJwt signedJwt) {
        super(signedJwt);
    }
     ...
     */
    public StringBasedSignedJwt(final JwsHeader header,
