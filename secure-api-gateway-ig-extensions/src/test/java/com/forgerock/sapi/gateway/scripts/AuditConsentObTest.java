        ...
        return json(object(field("type", GROOVY_MIME_TYPE),
                           ...
                           field("args",
                                 object(field("auditService", "${heap['AuditService']}"),
                                        ...
                                        field("consentIdLocatorExpr", "\\${attributes.openbanking_intent_id}"),
                                        field("consentIdLocator", "contexts.attributes.openbanking_intent_id"),
                                        // TODO[fix/break "consentIdLocator"] field("consentIdLocator", "contexts.attributes.attributes.openbanking_intent_id"),
                                        field("role", "CBPII"),
                                        field("event", "EXEC")))));
    }
}
